      ...
      <main className="flex-1">
        ...
        <section className="hero-section hidden md:block opacity-0 relative bg-[#efefef] overflow-hidden h-[840px] md:h-[720px] lg:h-[800px]">
          <div className="mx-auto w-full max-w-[1600px] h-full relative px-0">
            ...
            <div className="hero-main-image absolute z-[4] left-1/2 -translate-x-1/2 overflow-hidden shadow-[0_12px_30px_rgba(0,0,0,0.10)] top-[-10px] w-[820px] h-[480px] md:w-[700px] md:h-[410px]">
              <Image
                src="https://ik.imagekit.io/q0yw2qaik/Camiseta%20IAP%20BARREIRINHA/PEDRO%20E%20SARA%20-%20COSTAS%20E%20FRENTE.jpg"
            ...
            <div className="hero-bottom-word absolute z-[2] left-1/2 -translate-x-1/2 pointer-events-none text-center bottom-[210px] md:bottom-[200px]">
        ...
        <section className="mobile-hero-section mobile-hero-section--refined md:hidden block opacity-0 relative bg-[#efefef] overflow-hidden h-[100svh] min-h-[760px]">
          <div className="w-full h-full relative">
            ...
            <div className="mobile-hero-main-image absolute z-[4] top-[75px] left-1/2 -translate-x-1/2 w-[292px] h-[315px] overflow-hidden shadow-[0_10px_24px_rgba(0,0,0,0.10)]">
              <Image
                src="https://ik.imagekit.io/q0yw2qaik/Camiseta%20IAP%20BARREIRINHA/Carol%20costas.jpg"
            ...
            <div className="mobile-hero-bottom-word absolute z-[2] left-1/2 -translate-x-1/2 pointer-events-none text-center bottom-[240px]">
