...
export function ManifestoSection() {
  ...
  const secondaryPhraseClasses = "font-headline uppercase leading-[0.96] tracking-[-0.025em] text-[#c9c9c9] transition-all duration-220 ease-in-out hover:text-[#111111] hover:-translate-y-0.5 cursor-default text-center block animate-on-scroll";
  
  const imageClasses = "relative overflow-hidden shadow-[0_12px_28px_rgba(0,0,0,0.08)] transition-all duration-220 ease-in-out hover:scale-[1.03] hover:shadow-[0_18px_34px_rgba(0,0,0,0.12)] bg-white animate-on-scroll";

  return (
    <section ref={sectionRef} className="relative bg-[#efefef] py-[52px] lg:py-[88px] pb-[56px] lg:pb-[90px] overflow-hidden">
      <div ref={containerRef} className="container mx-auto px-6 max-w-[1440px]">
        <div className="flex flex-col items-center">
          ...
          <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-6 lg:gap-[42px]">
            ...
            <div className="text-center order-1 lg:order-2 px-4 py-4 lg:py-0 lg:pt-8 animate-on-scroll">
